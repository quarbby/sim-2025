...
struct Output_Graph : public Output {
	std::vector<int> get_output_timeperiods(const dynet::ParameterMap& params, Construct& construct) override {
		int time_count = construct.time_count;
		std::vector<int> time_vector(time_count);
